  ...
  return (
    <div className="p-4 max-w-md mx-auto w-full pb-24">
      ...
      <form action={updateSettings} className="space-y-6">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number"
                name="eggCrateCost"
                defaultValue={settings.eggs.crateCost}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1">
              ...
              <input type="number"
                name="eggsPerCrate"
                defaultValue={settings.eggs.eggsPerCrate}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              ...
              <input type="number"
                step="0.01"
                name="eggUnitCost"
                defaultValue={settings.eggs.unitCost}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              ...
              <input type="number"
                name="eggSellingPrice"
                defaultValue={settings.eggs.sellingPrice}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number"
                name="smokieBagCost"
                defaultValue={Number(settings.smokies.bagCost.toFixed(2))}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              ...
              <input type="number"
                name="smokiesPerBag"
                defaultValue={settings.smokies.quantityPerBag}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              ...
              <input type="number"
                step="0.01"
                name="smokieUnitCost"
                defaultValue={Number(settings.smokies.unitCost.toFixed(2))}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              ...
              <input type="number"
                name="smokieSellingPrice"
                defaultValue={settings.smokies.sellingPrice}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number"
                name="chapatiBagCost"
                defaultValue={settings.chapati.bagCost}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              ...
              <input type="number"
                name="chapatisPerBag"
                defaultValue={settings.chapati.quantityPerBag}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              ...
              <input type="number"
                step="0.01"
                name="chapatiUnitCost"
                defaultValue={settings.chapati.unitCost}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
            <div>
              ...
              <input type="number"
                name="chapatiSellingPrice"
                defaultValue={settings.chapati.sellingPrice}
                required
                className="w-full p-2 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-500 text-gray-900 bg-white"
              />
            </div>
        ...
        <button
          type="submit"
          className="w-full bg-gray-800 hover:bg-gray-900 text-white font-bold text-lg py-4 rounded-xl shadow-lg transition-colors"
        >
          SAVE SETTINGS
        </button>
      </form>
